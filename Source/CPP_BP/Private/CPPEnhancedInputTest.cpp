...
ACPPEnhancedInputTest::ACPPEnhancedInputTest()
{
	...
	// Input Actionを読込
	ActionInput = LoadObject<UInputAction>(NULL, TEXT("/Game/Input/Actions/IA_Action"), NULL, LOAD_None, NULL);//IA_Actionがあるフォルダーの位置を記述する必要がある
	AxisInput = LoadObject<UInputAction>(NULL, TEXT("/Game/Input/Actions/IA_Axis"), NULL, LOAD_None, NULL);//IA_Axisがあるフォルダーの位置を記述する必要がある

	// Input Mapping Contextを読込
	DefaultMappingContext = LoadObject<UInputMappingContext>(NULL, TEXT("/Game/Input/IMC_Default"), NULL, LOAD_None, NULL);//IMC_Defaultがあるフォルダーの位置を記述する必要がある
